      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link misma" href="#sesion">Inicio sesion</a>
            </li>
            <li class="nav-item">
        ...
        <a class="" href="./en/index(en).php">Traducir a inglés</a>
      </div>
    </nav>
...
if (isset($_POST['user']))
{
  ...
  else
  {
    ...
    if ($result->num_rows == 0)
    {
      $error = "usuario o contraseña no valida";
    }
    else
    {
...
?>
<div class="container">
  <form class="form-horizontal" role="form" method="POST" action="./index.php#sesion">
          <div class="row">
